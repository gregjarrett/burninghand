/**
   Burning Hands V4 Pool Migrator Installed
   #BURNER 
        *
    *
   ***    *
  ******  ** 
   ********
   ...
   #LIQ+#RFI+#SHIB+#SAFE+#ASS = #BURNER

   #BURNER features:
   3% fee auto add to the liquidity pool to locked forever when selling
   3% fee auto distribute to all holders
   With a magic black hole so #BURNER token will deflate itself in supply with every transaction
...
contract BURNER is Context, IERC20, Ownable {
    ...
    string private _name = "Burning Hand II";
